...
import {supplierMaterialInputs, supplierorderInputs,supplierInputs,categoryInputs, HrManagerInputs,EmployeeTrainInputs,EmployeetaskInputs ,EmployeeInputs,productInputs,productinventoryInputs,rawmatrialInputs,rawmatrialinventoryInputs,manufacturInputs} from './formSource';
        ...
        <Routes>
          ...
          <Route index element={<Login  saveUserData={saveUserData} />} />
           ...
           <Route path="employeetask">
            ...
            <Route path="newsupplymatrial/:suppliermatrialId" element={<ProtectedRout  userdata={userData}> <NotvalidInventory userEmail={userEmail}><NewSupplierMatrial  logOut={logOut} inputs={supplierMaterialInputs} title="Add New Supplying Material To Supplier "/></NotvalidInventory></ProtectedRout>} />
          </Route>
