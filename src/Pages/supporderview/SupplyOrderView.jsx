            ...
            <div className="manufacturTopRight">
              ...
              >
                <button
                  ...
                  style={{
                    color:
                      supporderdata.orderStatus === "pending"
                        ? "blue"
                        : "lightgray",
                  }}
                  disabled={
                    supporderdata.orderStatus !== "pending" ? true : false
                  }
                >
                  Shipped
                </button>
                <button
                  ...
                  style={{
                    color:
                      supporderdata.orderStatus !== "fullfilled"
                        ? "blue"
                        : "lightgray",
                  }}
                  disabled={
                    supporderdata.orderStatus === "fullfilled" ? true : false
                  }
                >
                  fulfilled
                </button>
